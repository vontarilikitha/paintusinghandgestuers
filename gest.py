    ...
    if result.multi_hand_landmarks:
        ...
        for handslms in result.multi_hand_landmarks:
            ...
            if len(landmarks) >= 9:
                ...
                if all(finger[0] > finger[1] for finger in landmarks[5:]) and thumb_tip[0] < index_tip[0]:
                    # Save the canvas
                    cv2.imwrite('thumbs_up_canvas.png', paintWindow)
        ...
        if (thumb[1]-center[1]<30):
            ...
            if 40 <= center[0] <= 140: # ClearQQ Button
